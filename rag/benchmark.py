...
if __name__ == '__main__':
    print('*****************LumeFlow Benchmark*****************')
    parser = argparse.ArgumentParser(usage="benchmark.py <max_docs> <kb_id> <dataset> <dataset_path> [<miracl_corpus_path>])", description='LumeFlow Benchmark')
