...
本文档提供了向 LumeFlow 提交贡献的指导原则和主要注意事项。

- 如需报告错误，请通过[GitHub issue](https://github.com/Devilfrom/LumeFlow/issues/new/choose)提交问题。
- 其他疑问可先在[Discussions](https://github.com/Devilfrom/LumeFlow/discussions)中查阅现有讨论或发起新话题。
